...
from sklearn.preprocessing import RobustScaler , FunctionTransfomer 
...
class DataTransformationConfig:
    ...
    transfrom_train_file_path=os.path.join(artifact_dir,'train.npy')
    transformed_test_file_path=os.path.join(artifact_dir,'test.npy')
    transformed_target_file_path=os.path.join(artifact_dir,'preprocessor.pkl')
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            raise CustomException(e,sys)
    def transform_data_transformation(self):
        logging.info("Entered initiate_data_transformation method  of Data Transformation class")

        try:
            dataframe= self.get_data(fetaure_store_file_path=self.feature_store_file_path)
